...
def main():
    ...
    # Sort by publication_date, then 14 digits after the URL, and finally by version
    output_data = sorted(output_data, key=itemgetter('publication_date', 'url', 'version'))
